...
const heroTitleAccent = "hukuki çözüm.";
...
const heroHighlights = ["Şeffaf süreç", "Güncel içtihat", "Etkin iletişim"];
const heroChecklist = [
  ...
  return (
    <section id="ana-sayfa" className="relative flex min-h-screen items-center overflow-hidden pt-[120px] pb-20">
      ...
      <div className="section-container relative z-10 grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          <span className="inline-flex items-center gap-2.5 rounded-full border border-accent/20 bg-accent-pale px-4 py-2 text-[13px] font-semibold uppercase tracking-wider text-primary-deep">
        ...
        <aside className="relative rounded-2xl border border-border bg-card p-8 shadow-elegant-lg">
