---
title: "Sahte İcra Mesajı Dolandırıcılığı: E-Devlet ve Hukuk Bürosu Yalanına Dikkat"
slug: sahte-icra-mesaji-dolandiriciligi
excerpt: "Vatandaşlara e-Devlet veya hukuk bürosu adına gönderilen sahte icra
  SMS'leri ile yapılan dolandırıcılık yöntemleri, mağdurların izlemesi gereken
  adımlar ve cezai yaptırımlar. "
...
seoTitle: Sahte İcra Mesajı Dolandırıcılığı | Vega Hukuk İstanbul
seoDescription: "Sahte icra mesajı veya e-Devlet SMS'i aldığınızda ne
  yapmalısınız? Bilişim sistemleri aracılığıyla nitelikli dolandırıcılık suçu
...
topics:
  - sahte-icra-mesaji
  - " e-devlet-sahte-sms"
  - bilisim-sistemi-dolandiricilik
pillars:
  p1: /hizmetler/ceza-hukuku
  p2: " /hizmetler/bilisim-hukuku"
tldr: >
  Son dönemde e-Devlet veya hukuk büroları adına gönderilen sahte icra takibi
  mesajları, bilişim sistemleri aracılığıyla işlenen nitelikli dolandırıcılık
  suçunu oluşturur. Böyle bir mesaj veya arama aldığınızda kesinlikle linklere
  tıklamayın, para transferi yapmayın. Doğrudan gerçek e-Devlet kapısından
  sorgulama yapın ve suç duyurusunda bulunun.
faqJson: >
  [

  {

  "question": "Bana 'hakkınızda icra takibi var' diye mesaj geldi, ne yapmalıyım?",

  "answer": "Öncelikle sakin olun ve mesajdaki hiçbir linke tıklamayın. Size verilen numarayı aramayın. Doğrudan tarayıcınızdan turkiye.gov.tr adresine girerek e-Devlet üzerinden veya UYAP Vatandaş portalından hakkınızda açılmış bir icra takibi olup olmadığını kontrol edin."

  },

  {

  "question": "Sahte e-Devlet sitesine T.C. kimlik numaramı girdim, tehlikede miyim?",

  "answer": "Kişisel verilerinizi sahte bir siteye girdiyseniz risk altındasınız. Bu durum hem dolandırıcılık teşebbüsü hem de kişisel verilerin ele geçirilmesidir. Derhal bankalarınızla iletişime geçerek hesaplarınızı güvenceye alın ve savcılığa suç duyurusunda bulunun."

  },

  {

  "question": "Telefondaki kişi kendini avukat olarak tanıttı ve baro sicilini verdi, yalan olabilir mi?",

  "answer": "Evet, dolandırıcılar kamuya açık olan baro levhalarından gerçek avukatların isim ve sicil numaralarını bularak güven sağlamaya çalışmaktadır. Hukuk büroları sizi arayıp aceleyle IBAN'a para göndermenizi istemez. İlgili avukatı baro levhasındaki resmi numarasından arayarak teyit edin."

  },

  {

  "question": "Paramı dolandırıcılara gönderdim, geri alabilir miyim?",

  "answer": "Para transferini yaptığınızı fark ettiğiniz an vakit kaybetmeden bankanızı arayıp işleme itiraz edin ve şüpheli işlem bildirimi yapın. Ardından dekontlar, arama kayıtları ve mesajlarla birlikte Cumhuriyet Başsavcılığına şikayette bulunun. Hukuki süreç başlatılarak failin tespiti halinde tazmin imkanı doğabilir."

  },

  {

  "question": "Sahte mesajla dolandırıcılık suçunun cezası nedir?",

  "answer": "TCK m. 158/1-f uyarınca bilişim sistemlerinin, banka veya kredi kurumlarının araç olarak kullanılması suretiyle işlenen nitelikli dolandırıcılık suçunun cezası dört yıldan on yıla kadar hapis ve suçtan elde edilen menfaatin iki katından az olmamak üzere adlî para cezasıdır."
...
**Hukuki uyarı:** Bu içerik yalnızca bilgilendirme amacıyla hazırlanmıştır ve hukuki tavsiye niteliği taşımaz. Hukuk kuralları, yargı kararları ve mevzuat sürekli değişebileceğinden, somut olaylara ilişkin güncel durum farklılık gösterebilir. Şüpheli bir durumla karşılaştığınızda somut olaya özgü değerlendirme için [büromuzla iletişime geçiniz](/iletisim).

**Gözden geçirme:** Av. Aykut Yeşilkaya ([İstanbul Barosu sicil no: 61223](/ekip/aykut-yesilkaya)) tarafından 2026-05-17 itibarıyla incelenmiştir.
...
- [USOM (Ulusal Siber Olaylara Müdahale Merkezi)](https://www.usom.gov.tr/ihbar) üzerinden sahte siteyi ihbar edin.
- Kişisel verilerinizin çalındığı şüphesiyle [Kişisel Verileri Koruma Kurumuna (KVKK)](https://www.kvkk.gov.tr) şikayette bulunun.
...
Şüphelendiğiniz bir mesaj veya arama hakkında hukuki durumunuzu değerlendirmek, suç duyurusu sürecini profesyonelce yürütmek için hukuki danışmanlık hizmetlerimizden faydalanabilirsiniz. Detaylı bilgi için [başvuru formumuzu doldurabilirsiniz](/iletisim).
